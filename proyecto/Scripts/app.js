...
document.getElementById("input").value = `Word Cup 1998--Brazil,Norway,Morocco,Scotland--Brazil#2@1#Scotland,Norway#2@2#Morocco,Scotland#1@1#Norway,Brazil#3@0#Morocco,Morocco#3@0#Scotland,Brazil#1@2#Norway`;
...
function resolverTorneo(torneo) {
    ...
    matches.forEach(match => {
        ...
        const [team1, goals1Str] = part1.split("#");
        const [goals2Str, team2] = part2.split("#");
